...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        rootLoader.setLocation(MainApp.class.getResource("/org/example/prueba1/view/root-layout.fxml"));
    ...
    public void showPersonView() {
        try {
            ...
            loader.setLocation(MainApp.class.getResource("/org/example/prueba1/view/person-view.fxml"));
    ...
    public boolean showPersonEditDialog(Person person) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("/org/example/prueba1/view/person-edit-dialog.fxml"));
    ...
    public void loadPersonDataFromFile(File file) {
        try {
            ...
            dialog.setTitle("Exception Details");
