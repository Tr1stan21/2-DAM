...
public class PedidoDAOImpl implements PedidoDAO {
    ...
    /**
     * Devuelve las l�neas de un pedido. Aqu� hacemos un JOIN con Producto.
     * Si quieres usar tambi�n nombre/precio del producto, puedes:
     *  - a�adir un campo Producto a LineaPedido, o
     *  - crear un DTO espec�fico.
     */
    @Override
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    // Si ampl�as LineaPedido con un Producto, aqu� podr�as hacer algo como:
    ...
    /**
     * Crea un pedido completo (cabecera + l�neas) en una sola transacci�n.
     */
    @Override
